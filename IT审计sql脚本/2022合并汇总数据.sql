...
SELECT sum(
               case
                   when active_time < '2022-01-01' and DATE_ADD(active_time, INTERVAL pk_period MONTH) > '2022-01-01'
                       then 1
       ...
       sum(
               case
                   when active_time < '2022-02-01' and DATE_ADD(active_time, INTERVAL pk_period MONTH) > '2022-02-01'
                       then 1
       ...
       sum(
               case
                   when active_time < '2022-03-01' and DATE_ADD(active_time, INTERVAL pk_period MONTH) > '2022-03-01'
                       then 1
       ...
       sum(
               case
                   when active_time < '2022-04-01' and DATE_ADD(active_time, INTERVAL pk_period MONTH) > '2022-04-01'
                       then 1
       ...
       sum(
               case
                   when active_time < '2022-05-01' and DATE_ADD(active_time, INTERVAL pk_period MONTH) > '2022-05-01'
                       then 1
       ...
       sum(
               case
                   when active_time < '2022-06-01' and DATE_ADD(active_time, INTERVAL pk_period MONTH) > '2022-06-01'
                       then 1
       ...
       sum(
               case
                   when active_time < '2022-07-01' and DATE_ADD(active_time, INTERVAL pk_period MONTH) > '2022-07-01'
                       then 1
