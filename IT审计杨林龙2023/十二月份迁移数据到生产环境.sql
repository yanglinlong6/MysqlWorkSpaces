...
CREATE TABLE dj_car_maintain_20240116 LIKE dj_car_maintain;
INSERT INTO dj_car_maintain_20240116 SELECT * FROM dj_car_maintain;
select count(1) from dj_car_maintain;
select count(1) from dj_car_maintain_20240116;
SELECT * FROM dj_car_maintain;


-- DROP TABLE dj_car_shop_warning;
CREATE TABLE dj_car_shop_warning_20240116 LIKE dj_car_shop_warning;
INSERT INTO dj_car_shop_warning_20240116 SELECT * FROM dj_car_shop_warning;
select count(1) from dj_car_shop_warning;
select count(1) from dj_car_shop_warning_20240116;
...
CREATE TABLE ddh_rescue_event_20240116 LIKE ddh_rescue_event;
INSERT INTO ddh_rescue_event_20240116 SELECT * FROM ddh_rescue_event;
select count(1) from ddh_rescue_event;
select count(1) from ddh_rescue_event_20240116;
...
((active_time < '2023-12-01 00:00:00' AND DATE_ADD(active_time,INTERVAL pk_period MONTH) > '2023-12-01 00:00:00') OR
(active_time >= '2023-12-01 00:00:00' AND active_time < '2023-12-31 23:59:59'));



SELECT * FROM dj_device_details;
CREATE TABLE dj_device_details_20240116 LIKE dj_device_details;
INSERT INTO dj_device_details_20240116 SELECT * FROM dj_device_details;
select count(1) from dj_device_details;
select count(1) from dj_device_details_20240116;
DROP TABLE dj_device_details;


-- 校验差异
SELECT LEFT(settle_time,7), count(1) FROM dj_device_details_20240116 GROUP BY LEFT(settle_time,7);
SELECT LEFT(settle_time,7), count(1) FROM dj_device_details GROUP BY LEFT(settle_time,7);

SELECT LEFT(settle_time,10), count(1) FROM dj_device_details_20240116 GROUP BY LEFT(settle_time,10);
SELECT LEFT(settle_time,10), count(1) FROM dj_device_details GROUP BY LEFT(settle_time,10);

SELECT LEFT(active_time,10), count(1) FROM dj_device_details_20240116 GROUP BY LEFT(active_time,10);
SELECT LEFT(active_time,10), count(1) FROM dj_device_details GROUP BY LEFT(active_time,10);

SELECT * FROM dj_device_details a LEFT JOIN dj_device_details_20240116 b ON b.sn = a.sn 
WHERE b.sn IS NULL  ;


-- 备份修改服务期限之前的表
SELECT count(1)  FROM dj_device_details;
CREATE TABLE dj_device_details_20240131 LIKE dj_device_details;
INSERT INTO dj_device_details_20240131 SELECT * FROM dj_device_details;
select count(1) from dj_device_details;
select count(1) from dj_device_details_20240131;
-- DROP TABLE dj_device_details;

-- 将历史表中的期限更新到dj_device_details表
SELECT a.*, a.id, b.id,a.pk_period ,b.pk_period ,a.active_merchant ,b.active_merchant ,a.active_time ,b.active_time 
FROM dj_device_details_20240131 a
LEFT JOIN dj_device_details b ON b.id = a.id
WHERE a.pk_period != b.pk_period ;

UPDATE dj_device_details_20240116 a LEFT JOIN dj_device_details b ON b.id = a.id
SET b.pk_period = a.pk_period WHERE a.pk_period != b.pk_period ; 
...
SELECT * FROM dj_device_details_return;
CREATE TABLE dj_device_details_return_20240116 LIKE dj_device_details_return;
INSERT INTO dj_device_details_return_20240116 SELECT * FROM dj_device_details_return;
select count(1) from dj_device_details_return;
SELECT count(1) FROM dj_device_details_return_20230724 dddr ;
select count(1) from dj_device_details_return_20240116;
-- DROP TABLE dj_device_details_return;
SELECT * FROM dj_device_details_return_20240116 ORDER BY settle_time DESC ;
SELECT * FROM dj_device_details_return_20230724 ORDER BY settle_time DESC ;

-- 合并2023年退货数据到生产退货表
INSERT INTO dj_device_details_return (channel,sn,device_type,delivery_time,delivery_merchant,active_time,active_merchant,pk_name,pk_period,settle_merchant,settle_order,settle_time,pk_price,hw_price,install_price,hw_cost,install_cost)
SELECT channel,sn,device_type,delivery_time,delivery_merchant,active_time,active_merchant,pk_name,pk_period,settle_merchant,settle_order,settle_time,pk_price,hw_price,install_price,hw_cost,install_cost
FROM dj_2023_settle_details_return WHERE settle_time >= '2023-07-01';

CREATE TABLE dj_device_details_return LIKE dj_device_details_return_20230724;
SELECT * FROM dj_2023_settle_details_return ORDER BY settle_time DESC ;
SELECT * FROM dj_device_details_return_20230724 ORDER BY settle_time DESC ;
SELECT * FROM dj_device_details_return_20240116 ORDER BY settle_time DESC ;
SELECT * FROM dj_device_details_return ORDER BY settle_time DESC ;
INSERT INTO dj_device_details_return SELECT * FROM dj_device_details_return_20240116;


SELECT * FROM dj_system_merchant;
CREATE TABLE dj_system_merchant_20240116 LIKE dj_system_merchant;
INSERT INTO dj_system_merchant_20240116 SELECT * FROM dj_system_merchant;
select count(1) from dj_system_merchant;
select count(1) from dj_system_merchant_20240116;
DROP TABLE dj_system_merchant;


SELECT * FROM dj_2023_settlment_order;
CREATE TABLE dj_2023_settlment_order_20240116 LIKE dj_2023_settlment_order;
INSERT INTO dj_2023_settlment_order_20240116 SELECT * FROM dj_2023_settlment_order;
select count(1) from dj_2023_settlment_order;
select count(1) from dj_2023_settlment_order_20240116;
DROP TABLE dj_2023_settlment_order;


SELECT * FROM dj_2023_settle_details_return;
CREATE TABLE dj_2023_settle_details_return_20240116 LIKE dj_2023_settle_details_return;
INSERT INTO dj_2023_settle_details_return_20240116 SELECT * FROM dj_2023_settle_details_return;
select count(1) from dj_2023_settle_details_return;
select count(1) from dj_2023_settle_details_return_20240116;
DROP TABLE dj_2023_settle_details_return;

select * from dj_basic_device_info;

-- DROP TABLE dj_basic_device_info;
CREATE TABLE dj_basic_device_info_20240117 LIKE dj_basic_device_info;
INSERT INTO dj_basic_device_info_20240117 SELECT * FROM dj_basic_device_info;
select count(1) from dj_basic_device_info;
select count(1) from dj_basic_device_info_20240117;


SELECT * FROM dj_basic_device_info WHERE LEFT(active_time,4)=2023  ;
SELECT * FROM dj_basic_device_info WHERE sn IN (SELECT sn FROM dj_device_details);
...
FROM dj_device_details WHERE settle_time >= '2023-07-01';

SELECT * FROM dj_basic_device_info WHERE delivery_time >= '2023-07-01';
SELECT * FROM dj_device_details WHERE delivery_time >= '2023-07-01' ORDER BY delivery_time DESC ; 
select * from dj_basic_device_info WHERE sn = 'GC120SHAY30531BBD';

select cus_name,finance_time,sale_type,device_type,total,pk_name,pk_term,hw_unit_price,
          pk_unit_price,install_unit_price,id from dj_2023_settlment_order
          where  cus_name ='其他';
         
select cus_name,finance_time,sale_type,device_type,total,pk_name,pk_term,hw_unit_price,
          pk_unit_price,install_unit_price,id from dj_2023_settlment_order_20240116 dso 
          where  cus_name ='其他';         
         
select merchant_name,settle_merchant_name from dj_system_merchant 
where settle_merchant_name ='其他' ; 

UPDATE dj_2023_settlment_order SET sale_type = '渠道' WHERE cus_name ='其他';  

SELECT * FROM dj_device_details WHERE settle_time >= '2023-01-01' AND channel = '直销';

SELECT * FROM dj_device_details ddd WHERE ddd.sn = 'SH23G2312121087';
